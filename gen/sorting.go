...
func (s DeliverySortType) ApplyWithAlias(ctx context.Context, dialect gorm.Dialect, alias string, sorts *[]SortInfo, joins *[]string) error {
	...
	if s.Mode != nil {
		sort := SortInfo{Field: aliasPrefix + dialect.Quote("mode"), Direction: s.Mode.String()}
		*sorts = append(*sorts, sort)
	}

	if s.ModeMin != nil {
		sort := SortInfo{Field: "Min(" + aliasPrefix + dialect.Quote("mode") + ")", Direction: s.ModeMin.String(), IsAggregation: true}
		*sorts = append(*sorts, sort)
	}

	if s.ModeMax != nil {
		sort := SortInfo{Field: "Max(" + aliasPrefix + dialect.Quote("mode") + ")", Direction: s.ModeMax.String(), IsAggregation: true}
		*sorts = append(*sorts, sort)
	}
...
// Apply method
func (s DeliverSortType) Apply(ctx context.Context, dialect gorm.Dialect, sorts *[]SortInfo, joins *[]string) error {
	return s.ApplyWithAlias(ctx, dialect, TableName("delivers"), sorts, joins)
}

// ApplyWithAlias method
func (s DeliverSortType) ApplyWithAlias(ctx context.Context, dialect gorm.Dialect, alias string, sorts *[]SortInfo, joins *[]string) error {
	aliasPrefix := dialect.Quote(alias) + "."
...
func (s PersonSortType) ApplyWithAlias(ctx context.Context, dialect gorm.Dialect, alias string, sorts *[]SortInfo, joins *[]string) error {
	...
	if s.DeliveriesSentID != nil {
		sort := SortInfo{Field: aliasPrefix + dialect.Quote("deliveriesSentId"), Direction: s.DeliveriesSentID.String()}
		*sorts = append(*sorts, sort)
	}

	if s.DeliveriesSentIDMin != nil {
		sort := SortInfo{Field: "Min(" + aliasPrefix + dialect.Quote("deliveriesSentId") + ")", Direction: s.DeliveriesSentIDMin.String(), IsAggregation: true}
		*sorts = append(*sorts, sort)
	}

	if s.DeliveriesSentIDMax != nil {
		sort := SortInfo{Field: "Max(" + aliasPrefix + dialect.Quote("deliveriesSentId") + ")", Direction: s.DeliveriesSentIDMax.String(), IsAggregation: true}
		*sorts = append(*sorts, sort)
	}

	if s.DeliveriesReceivedID != nil {
		sort := SortInfo{Field: aliasPrefix + dialect.Quote("deliveriesReceivedId"), Direction: s.DeliveriesReceivedID.String()}
		*sorts = append(*sorts, sort)
	}

	if s.DeliveriesReceivedIDMin != nil {
		sort := SortInfo{Field: "Min(" + aliasPrefix + dialect.Quote("deliveriesReceivedId") + ")", Direction: s.DeliveriesReceivedIDMin.String(), IsAggregation: true}
		*sorts = append(*sorts, sort)
	}

	if s.DeliveriesReceivedIDMax != nil {
		sort := SortInfo{Field: "Max(" + aliasPrefix + dialect.Quote("deliveriesReceivedId") + ")", Direction: s.DeliveriesReceivedIDMax.String(), IsAggregation: true}
		*sorts = append(*sorts, sort)
	}
