...
type DeliverFilterType struct {
	And                  []*DeliverFilterType `json:"AND"`
	Or                   []*DeliverFilterType `json:"OR"`
	ID                   *string              `json:"id"`
...
type DeliveryFilterType struct {
	...
	ModeMin                   *string               `json:"modeMin"`
	ModeMax                   *string               `json:"modeMax"`
	ModeNe                    *string               `json:"mode_ne"`
	ModeMinNe                 *string               `json:"modeMin_ne"`
	ModeMaxNe                 *string               `json:"modeMax_ne"`
	ModeGt                    *string               `json:"mode_gt"`
	ModeMinGt                 *string               `json:"modeMin_gt"`
	ModeMaxGt                 *string               `json:"modeMax_gt"`
	ModeLt                    *string               `json:"mode_lt"`
	ModeMinLt                 *string               `json:"modeMin_lt"`
	ModeMaxLt                 *string               `json:"modeMax_lt"`
	ModeGte                   *string               `json:"mode_gte"`
	ModeMinGte                *string               `json:"modeMin_gte"`
	ModeMaxGte                *string               `json:"modeMax_gte"`
	ModeLte                   *string               `json:"mode_lte"`
	ModeMinLte                *string               `json:"modeMin_lte"`
	ModeMaxLte                *string               `json:"modeMax_lte"`
	ModeIn                    []string              `json:"mode_in"`
	ModeMinIn                 []string              `json:"modeMin_in"`
	ModeMaxIn                 []string              `json:"modeMax_in"`
	ModeLike                  *string               `json:"mode_like"`
	ModeMinLike               *string               `json:"modeMin_like"`
	ModeMaxLike               *string               `json:"modeMax_like"`
	ModePrefix                *string               `json:"mode_prefix"`
	ModeMinPrefix             *string               `json:"modeMin_prefix"`
	ModeMaxPrefix             *string               `json:"modeMax_prefix"`
	ModeSuffix                *string               `json:"mode_suffix"`
	ModeMinSuffix             *string               `json:"modeMin_suffix"`
	ModeMaxSuffix             *string               `json:"modeMax_suffix"`
	ModeNull                  *bool                 `json:"mode_null"`
	...
	Deliver                   *DeliverFilterType    `json:"deliver"`
}
...
type DeliverySortType struct {
	...
	IDMin               *ObjectSortType  `json:"idMin"`
	IDMax               *ObjectSortType  `json:"idMax"`
	Mode                *ObjectSortType  `json:"mode"`
	ModeMin             *ObjectSortType  `json:"modeMin"`
	ModeMax             *ObjectSortType  `json:"modeMax"`
	...
	Deliver             *DeliverSortType `json:"deliver"`
}
...
type PersonFilterType struct {
	...
	UserIDMaxSuffix            *string             `json:"userIdMax_suffix"`
	UserIDNull                 *bool               `json:"userId_null"`
	DeliveriesSentID           *string             `json:"deliveriesSentId"`
	DeliveriesSentIDMin        *string             `json:"deliveriesSentIdMin"`
	DeliveriesSentIDMax        *string             `json:"deliveriesSentIdMax"`
	DeliveriesSentIDNe         *string             `json:"deliveriesSentId_ne"`
	DeliveriesSentIDMinNe      *string             `json:"deliveriesSentIdMin_ne"`
	DeliveriesSentIDMaxNe      *string             `json:"deliveriesSentIdMax_ne"`
	DeliveriesSentIDGt         *string             `json:"deliveriesSentId_gt"`
	DeliveriesSentIDMinGt      *string             `json:"deliveriesSentIdMin_gt"`
	DeliveriesSentIDMaxGt      *string             `json:"deliveriesSentIdMax_gt"`
	DeliveriesSentIDLt         *string             `json:"deliveriesSentId_lt"`
	DeliveriesSentIDMinLt      *string             `json:"deliveriesSentIdMin_lt"`
	DeliveriesSentIDMaxLt      *string             `json:"deliveriesSentIdMax_lt"`
	DeliveriesSentIDGte        *string             `json:"deliveriesSentId_gte"`
	DeliveriesSentIDMinGte     *string             `json:"deliveriesSentIdMin_gte"`
	DeliveriesSentIDMaxGte     *string             `json:"deliveriesSentIdMax_gte"`
	DeliveriesSentIDLte        *string             `json:"deliveriesSentId_lte"`
	DeliveriesSentIDMinLte     *string             `json:"deliveriesSentIdMin_lte"`
	DeliveriesSentIDMaxLte     *string             `json:"deliveriesSentIdMax_lte"`
	DeliveriesSentIDIn         []string            `json:"deliveriesSentId_in"`
	DeliveriesSentIDMinIn      []string            `json:"deliveriesSentIdMin_in"`
	DeliveriesSentIDMaxIn      []string            `json:"deliveriesSentIdMax_in"`
	DeliveriesSentIDNull       *bool               `json:"deliveriesSentId_null"`
	DeliveriesReceivedID       *string             `json:"deliveriesReceivedId"`
	DeliveriesReceivedIDMin    *string             `json:"deliveriesReceivedIdMin"`
	DeliveriesReceivedIDMax    *string             `json:"deliveriesReceivedIdMax"`
	DeliveriesReceivedIDNe     *string             `json:"deliveriesReceivedId_ne"`
	DeliveriesReceivedIDMinNe  *string             `json:"deliveriesReceivedIdMin_ne"`
	DeliveriesReceivedIDMaxNe  *string             `json:"deliveriesReceivedIdMax_ne"`
	DeliveriesReceivedIDGt     *string             `json:"deliveriesReceivedId_gt"`
	DeliveriesReceivedIDMinGt  *string             `json:"deliveriesReceivedIdMin_gt"`
	DeliveriesReceivedIDMaxGt  *string             `json:"deliveriesReceivedIdMax_gt"`
	DeliveriesReceivedIDLt     *string             `json:"deliveriesReceivedId_lt"`
	DeliveriesReceivedIDMinLt  *string             `json:"deliveriesReceivedIdMin_lt"`
	DeliveriesReceivedIDMaxLt  *string             `json:"deliveriesReceivedIdMax_lt"`
	DeliveriesReceivedIDGte    *string             `json:"deliveriesReceivedId_gte"`
	DeliveriesReceivedIDMinGte *string             `json:"deliveriesReceivedIdMin_gte"`
	DeliveriesReceivedIDMaxGte *string             `json:"deliveriesReceivedIdMax_gte"`
	DeliveriesReceivedIDLte    *string             `json:"deliveriesReceivedId_lte"`
	DeliveriesReceivedIDMinLte *string             `json:"deliveriesReceivedIdMin_lte"`
	DeliveriesReceivedIDMaxLte *string             `json:"deliveriesReceivedIdMax_lte"`
	DeliveriesReceivedIDIn     []string            `json:"deliveriesReceivedId_in"`
	DeliveriesReceivedIDMinIn  []string            `json:"deliveriesReceivedIdMin_in"`
	DeliveriesReceivedIDMaxIn  []string            `json:"deliveriesReceivedIdMax_in"`
	DeliveriesReceivedIDNull   *bool               `json:"deliveriesReceivedId_null"`
	UpdatedAt                  *time.Time          `json:"updatedAt"`
	UpdatedAtMin               *time.Time          `json:"updatedAtMin"`
	UpdatedAtMax               *time.Time          `json:"updatedAtMax"`
	UpdatedAtNe                *time.Time          `json:"updatedAt_ne"`
...
type PersonSortType struct {
	...
	UserIDMin               *ObjectSortType   `json:"userIdMin"`
	UserIDMax               *ObjectSortType   `json:"userIdMax"`
	DeliveriesSentID        *ObjectSortType   `json:"deliveriesSentId"`
	DeliveriesSentIDMin     *ObjectSortType   `json:"deliveriesSentIdMin"`
	DeliveriesSentIDMax     *ObjectSortType   `json:"deliveriesSentIdMax"`
	DeliveriesReceivedID    *ObjectSortType   `json:"deliveriesReceivedId"`
	DeliveriesReceivedIDMin *ObjectSortType   `json:"deliveriesReceivedIdMin"`
	DeliveriesReceivedIDMax *ObjectSortType   `json:"deliveriesReceivedIdMax"`
	UpdatedAt               *ObjectSortType   `json:"updatedAt"`
	UpdatedAtMin            *ObjectSortType   `json:"updatedAtMin"`
	UpdatedAtMax            *ObjectSortType   `json:"updatedAtMax"`
	CreatedAt               *ObjectSortType   `json:"createdAt"`
